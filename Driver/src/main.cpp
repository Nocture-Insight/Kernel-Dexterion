...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&driver_name, L"\\Device\\DexterionDriver");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\DexterionDriver");
...
NTSTATUS DriverEntry() {
	...
	UNICODE_STRING driver_name = {};
	RtlInitUnicodeString(&driver_name, L"\\Driver\\DexterionDriver");
